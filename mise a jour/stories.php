      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            <h1 class="mb-3 bread">Our <span>Story</span></h1>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            <h2 class="mb-3">FOUNDATIONS</h2>
            <p>Akany Tafita, also called « ATA », was founded by a people committee in the Anglican church in Madagascar whose goal is to share God’s love by helping needy people especially children but also the entire family. ATA is located in a very poor part of the city of Antananarivo and started to work in October 2002.
			</br>It is dependent on the Anglican Church in Madagascar.
			</p>
            <p>
              <img src="images/about.jpg" style="width: 99%;" alt="" class="img-fluid">
            </p>
            <h2 class="mb-3 mt-5">OUR MISSION</h2>
