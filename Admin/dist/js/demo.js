...
$(function () {
  ...
  demo_settings.append(
          ...
          + "</div>"
          + "<div class='form-group'>"
          + "<a href='../php/logout.php' class='btn btn-default btn-flat'>"
          + "Logout"
          + "</a>"
          + "</div>"
          );
  ...
  var skin_blue =
          ...
          .append("<a href='#' onclick='change_skin(\"skin-blue\")' style='display: block; box-shadow: -1px 1px 2px rgba(0,0,0,0.0);' class='clearfix full-opacity-hover'>"
                  + "<div><span style='display:block; width: 20%; float: left; height: 10px; background: #a02836;'></span><span class='bg-light-blue' style='display:block; width: 80%; float: left; height: 10px;'></span></div>"
                  ...
                  + "<p class='text-center'>Skin Garnet</p>"
                  + "</a>");
