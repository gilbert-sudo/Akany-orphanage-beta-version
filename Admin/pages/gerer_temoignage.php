...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Gérér les témoignage</title>
...
<link href="../bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
  ...
  <body class="skin-blue">
          ...
          $adWitness = $bdd->prepare("SELECT * FROM temoignage");
          $adWitness->execute();
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><b>Gérer les témoignages</b></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php 
                      while ($showWitness = $adWitness->fetch()) {
                       
                      
                      ?>
                      <tr>
                        <td><?= $showWitness['nom_temoin']; ?></td>
                        <td><?= $showWitness['title']; ?></td>
                        <td><?= $showWitness['function']; ?></td>
                        <td><?= $showWitness['lien_video']; ?></td>
                        <td><img style="width: 140px; height: 120px; " src="../images/Temoin/<?= $showWitness['images']; ?>"></td>
                        <td><div style="margin-top: 16px;"><a class="btn btn-block btn-danger" href="../php/del_witness.php?id_temoin=<?= $showWitness['id_temoin']; ?>"><i class="glyphicon glyphicon-trash"></i></a><br>
                          <a class="btn btn-block btn-primary" href="edit_witness.php?id_temoin=<?= $showWitness['id_temoin']; ?>"><i class="fa fa-edit"></i></a></div></td>
