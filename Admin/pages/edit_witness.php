...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Editer les témoignages</title>
 ...
 <link href="../bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
  ...
  <body class="skin-blue">
    <?php include'../php/edit_witness.php'; ?>
...
<header class="main-header">
    ...
    if (isset($_GET['id_temoin'])) {
      $get_id_temoin = $_GET['id_temoin'];
      $showwitness = $bdd->prepare("SELECT * FROM temoignage WHERE id_temoin = ?");
      $showwitness->execute(array($get_id_temoin));
      $editwitness = $showwitness->fetch();
  ...
  ?>
                  <div class="box-body">
                    <div class="form-group">
                      <label>Nom du temoin :</label>
                      <input type="text" class="form-control" name="newname" value="<?= $editwitness['nom_temoin'] ?>">
                    </div>
                    <div class="form-group">
                      <label>Titre :</label>
                      <input type="text" class="form-control" name="newtitle" value="<?= $editwitness['title'] ?>">
                    </div>
                    <div class="form-group">
                    <label>Fonction :</label>
                  <input type="text" class="form-control" name="newfunction" value="<?= $editwitness['function'] ?>">
                    </div>
                    <div class="form-group">
                    <label>Lien du vidéo :</label>
                  <input type="text" class="form-control" name="newlien" value="<?= $editwitness['lien_video'] ?>">
                    </div>
