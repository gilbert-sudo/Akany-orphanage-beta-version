           ...
           <ul class="sidebar-menu">
            ...
            <li class="treeview">
              <a href="ad_responsable.php">
                <i class="fa fa-edit"></i> <span>Ajouter un responsable</span>
            ...
            <li class="treeview">
              <a href="ad_event.php">
                <i class="fa fa-edit"></i> <span>Ajouter un évenements</span>
              </a>
            ...
            <li class="treeview">
              <a href="demande_dons.php">
                <i class="fa fa-edit"></i> <span>Demmande des dons</span>
