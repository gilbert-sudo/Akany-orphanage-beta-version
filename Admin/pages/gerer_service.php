...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Gérér les services</title>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Gérer les services</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php
                      while ($showservice = $reqservice->fetch()){ ?>
                      <tr>
                        <td><?= $showservice['types']; ?></td>
                        <td><?= $showservice['commentaires']; ?></td>
                       
                        <td><img style="width: 140px; height: 120px;" src="../images/services/<?= $showservice['images']; ?>" ></td>
                        <td><div style="margin-top: 16px;"><a class="btn btn-block btn-danger" href="../php/del_service.php?id_services=<?= $showservice['id_services']; ?>"><i class="glyphicon glyphicon-trash"></i></a><br>
                          <a class="btn btn-block btn-primary" href="edit_services.php?id_services=<?= $showservice['id_services']; ?>"><i class="fa fa-edit"></i></a></div></td>
                      </tr>
