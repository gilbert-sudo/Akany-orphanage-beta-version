...
<header class="main-header">
    ...
    if (isset($_GET['id_blog'])) {
      ...
      $showblog = $bdd->prepare("SELECT * FROM blog WHERE id_blog = ?");
      $showblog->execute(array($get_id_blog));
      if ($showblog->rowCount() == 1) {
          $editblog = $showblog->fetch();
      }
  ...
  ?>
                    <div class="form-group">
                      <label>Objet</label>
                      <input type="text" class="form-control" name="newobject" value="<?= $editblog['object'];?>">
                    </div>
                    <div class="form-group">
                    <label>Contenues :</label>
                     <textarea class="form-control" rows="3" name="newcontained"><?= $editblog['contained'];?></textarea>
                   </div>
                   <div>
          ...
          <div class="col-md-6">
              ...
              <div class="box box-primary">
                    ...
                    <div class="form-group">
                     <textarea class="form-control" rows="3" name="newcontainedtwo"><?= $editblog['contained_2'];?></textarea>
                   </div>
