          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              <a href="gerer_dons.php">
                <i class="fa fa-star"></i> <span>Gérer les dons</span>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><b>Gérer les dons</b></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?= $showdons['but']; ?></td>
                        <td><?= $showdons['fond']; ?></td>
                        <td><?= $showdons['description']; ?></td>
                        <td><img style="width: 140px; height: 120px; " src="../images/Demande_dons/<?= $showdons['images']; ?>"></td>
                        <td><div style="margin-top: 16px;"><a class="btn btn-block btn-danger" href="../php/del_demande_dons.php?id=<?= $showdons['id']; ?>"><i class="glyphicon glyphicon-trash"></i></a><br>
                          <a class="btn btn-block btn-primary" href="edit_dons.php?id=<?= $showdons['id']; ?>"><i class="fa fa-edit"></i></a></div></td>
