...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Editer une responsable</title>
...
<header class="main-header">
    ...
    if (isset($_GET['id_resp'])) {
      $get_id_resp = $_GET['id_resp'];
      $showresp = $bdd->prepare("SELECT * FROM responsable WHERE id_resp = ?");
      $showresp->execute(array($get_id_resp));
  ...
  ?>
                  <div class="box-body">
                    <div class="form-group">
                      <label>Nom</label>
                      <input type="text" class="form-control" name="newname" value="<?= $editresp['nom_resp'] ?>">
                    </div>
                    <div class="form-group">
                      <label>Prénom</label>
                      <input type="text" class="form-control" name="newpname" value="<?= $editresp['prenom_resp'] ?>">
                    </div>
                    <div class="form-group">
                    <label>Fonction</label>
                  <input type="text" class="form-control" name="newfunction" value="<?= $editresp['fonction'] ?>">
                    </div>
