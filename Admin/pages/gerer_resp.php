...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Gérér les responsable</title>
                ...
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?= $afresp['nom_resp']; ?></td>
                        <td><?= $afresp['prenom_resp']; ?></td>
                        <td><?= $afresp['fonction']; ?></td>
                        <td><img style="width: 140px; height: 120px;" src="../images/Responsable/<?= $afresp['image']; ?>" ></td>
                        <td><div style="margin-top: 16px;"><a class="btn btn-block btn-danger" href="../php/del_resp.php?id_resp=<?= $afresp['id_resp']; ?>"><i class="glyphicon glyphicon-trash"></i></a><br>
                          <a class="btn btn-block btn-primary" href="edit_resp.php?id_resp=<?= $afresp['id_resp']; ?>"><i class="fa fa-edit"></i></a></div></td>
                      </tr>
