                ...
                <div class="box-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      ...
                      ?>
                      <tr>
                        <td><?= $afresp['nom_resp']; ?><br><br><br>

                  <form method="POST" action="#">
                      <div class="col-xs-12">
                        <button class="btn btn-primary" style="margin-right: 5px;" name="mod"> Modifier</button>
                        <button class="btn btn-success" name="del"> Supprimer</button>
                        <?php include '../php/gerer_resp.php'; ?>
                      </div>
                  </form>
                        ...
                        <td><div><a class="cart_quantity_delete" href="">
<i class="fa fa-trash-o"></a></i></div></td>
