    ...
    <section class="ftco-section ftco-services-2" id="services-section">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-3 justify-content-center counter-wrap d-flex laign-self-stretch ftco-animate">
            <div class="media block-6 services text-center d-block">
              <div class="icon"><span class="flaticon-praying"></span></div>
              <div class="media-body">
                <h3 class="heading mb-3"><?= $showservice['types']?></h3>
                <p><?= $showservice['commentaires']?></p>
              </div>
            </div>      
          </div>
        <?php } ?>
