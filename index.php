	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav nav ml-auto">
	          ...
	          <li class="nav-item"><a href="#pastor-section" class="nav-link"><span>Leaders</span></a></li>
				...
				<div class="row mt-4 justify-content-end">
					<div class="col-lg-10">
						<div class="donated-intro bg-darken p-4 p-md-5">
							<h2>We expect over <strong class="number" data-number="<?= $total; ?>">0</strong><span>&nbsp;AR</span>&nbsp;/&nbsp;<strong class="number" data-number="<?= $totaleuro; ?>">0</strong><span>&nbsp;$</span></h2>
    ...
    <section class="ftco-section ftco-no-pb" id="pastor-section">
    	<div class="container">
          ...
          <div class="col-md-6 heading-section text-center ftco-animate">
            ...
            <h2 class="mb-4">Akany's leaders</h2>
            <p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
          </div>
        </div>
        <div class="row">
    	...
    	<div class="container-fluid px-4">
          ...
          <div class="col-md-7 heading-section ftco-animate text-center">
    		...
    		<div class="row">
               ...
               <p class="mb-0" style="margin-top: 10px; padding-left: 50px;"><a href="gallery.php" class="btn btn-primary">See more photos &nbsp;&nbsp;<span class="ion-ios-arrow-round-forward"></span></a></p>
        </div>
    	</div>
    </section>
